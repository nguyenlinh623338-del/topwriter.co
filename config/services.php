...
return [
    ...
    */
    ...
    'paypal' => [
        ...
        'return_url' => env('PAYPAL_RETURN_URL', 'https://topwriter.co/paypal-success'),
        'cancel_url' => env('PAYPAL_CANCEL_URL', 'https://topwriter.co/paypal-cancel'),
        'credits_return_url' => 'https://topwriter.co/credits/paypal/success',
