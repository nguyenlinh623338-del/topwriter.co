<x-guest-layout>
    ...
    <h2 class="text-2xl font-bold text-center mb-6 text-indigo-800">Đăng nhập</h2>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="text-center mt-6 pt-4 border-t border-gray-200">
            <p class="text-sm text-gray-600">Chưa có tài khoản? 
                <a href="{{ route('register') }}" class="font-semibold text-indigo-600 hover:text-indigo-900">Đăng ký ngay</a>
            </p>
        </div>
    </form>
