...
@media (max-width: 480px) {
    ...
    <script type="application/ld+json">
    {
        ...
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Medical Content Pricing Plans",
            "itemListElement": [
                {
                    "@type": "Offer",
                    "name": "Starter Plan",
                    ...
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Starter Plan - 5 Articles",
                        "description": "5 medical articles per month written by licensed M.D. writers with SEO and AI optimization"
                    },
                ...
                },
                {
                    ...
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Professional Plan - 10 Articles",
                        "description": "10 medical articles per month with Ahrefs Premium research, direct posting, and performance dashboard"
                    },
                    "availability": "InStock",
                ...
                },
                {
                    ...
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Enterprise Plan - 20 Articles",
                        "description": "20 medical articles per month with priority delivery, backlinks, and dedicated support"
                    },
                    "availability": "InStock",
    ...
    <section class="pricing">
        <div class="container">
            <div class="section-header" style="color: white;">
                ...
                <p style="color: rgba(255, 255, 255, 0.9);">Professional medical content by licensed M.D. & M.B.B.S. doctors with AI optimization. No hidden fees.</p>
            </div>
            ...
            <div class="pricing-cards">
                ...
                <div class="pricing-card">
                    ...
                    <div class="plan-description">Perfect for testing the waters and getting quality medical content</div>
                    ...
                    <div class="price">
                        ...
                        <div class="price-per-article">$300 per article</div>
                </div>

                    <div class="article-count">5 Articles × 1,000 words</div>

                    <ul class="features">
                        <li>
                            <span class="check-icon">✓</span>
                            <span>Licensed M.D. & M.B.B.S. writers</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>SEO & JSON optimization for AI</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>Professional medical images</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li>
                            <span class="check-icon">✓</span>
                            <span>7 business days delivery</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li>
                            ...
                            <span style="color: #999;">Ahrefs Premium keyword research</span>
                        </li>
                        <li>
                            <span class="cross-icon">✗</span>
                            <span style="color: #999;">Direct website posting</span>
                        </li>
                        <li>
                            <span class="cross-icon">✗</span>
                            <span style="color: #999;">Performance dashboard</span>
                        </li>
                        <li>
                            <span class="cross-icon">✗</span>
                            <span style="color: #999;">Landing page</span>
                        </li>
                    </ul>
                ...
                <div class="pricing-card recommended">
                    ...
                    <div class="plan-description">Most popular choice - complete hands-off solution with premium features</div>
                    ...
                    <div class="price-section">
                        ...
                        <div class="price-per-article">$280 per article (Save $20/article!)</div>
                </div>

                    <div class="article-count">10 Articles × 1,000 words</div>
                    ...
                    <ul class="features">
                        ...
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>Ahrefs Premium keyword research</strong> ($99/mo value)</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li>
                            <span class="check-icon">✓</span>
                            <span>Search volume & difficulty data</span>
                        </li>
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>Direct website posting</strong> (any CMS platform)</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>Monthly performance dashboard</strong></span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>Google ranking reports</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>1 HTML Landing Page/month</strong> ($500 value)</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li>
                            <span class="check-icon">✓</span>
                            <span><strong>5 business days delivery</strong> (faster priority)</span>
                        </li>
                    </ul>
                ...
                <div class="pricing-card" style="border: 2px solid #d4af37;">
                    <div class="plan-name">Enterprise</div>
                    <div class="plan-description">For serious scale with white-glove service and premium support</div>
                    ...
                    <div class="price-section">
                        ...
                        <div class="price-per-article">$250 per article (Best rate!)</div>
                    </div>

                    <div class="article-count">20 Articles × 1,000 words</div>
                    ...
                    <ul class="features">
                        ...
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>5-10 quality backlinks/month</strong></span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>Multi-platform AI optimization (ChatGPT, Perplexity, Claude)</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                        ...
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>Priority support: Chat + Email</strong></span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>3 business days delivery (fastest)</span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>10 free revisions</span>
                        </li>
                        <li class="feature-highlight">
                            <span class="check-icon">✓</span>
                            <span><strong>2 HTML Landing Pages/month</strong></span>
                        </li>
                        <li>
                            <span class="check-icon">✓</span>
                            <span>Quarterly content strategy audit</span>
                        </li>
                    </ul>
        ...
        <div class="container">
            ...
            <div class="faq-container">
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>We offer three monthly plans designed for different scale and optimization levels. <strong>Starter ($1,500)</strong> provides 5 M.D.-written articles with core SEO/AEO optimization. <strong>Professional ($2,800)</strong> includes 10 articles with advanced multi-platform AEO engineering, premium Ahrefs research, and significantly deeper optimization for both traditional search and AI discovery across ChatGPT, Perplexity, Claude, and Google AI. <strong>Enterprise ($5,000)</strong> delivers 20 articles with maximum-scale optimization, quality backlinks, and fastest delivery. Each tier represents a substantial difference in technical implementation depth and global visibility strategy.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What makes Professional Plan different from Starter?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>The Professional Plan represents a fundamental upgrade in technical depth and reach. Beyond double the content volume, you get: <strong>Advanced multi-platform AEO engineering</strong> (not just JSON-LD, but comprehensive technical optimization across multiple AI systems), <strong>premium Ahrefs data-driven keyword strategy</strong> for the US and global markets, <strong>direct website integration with optimized HTML structure</strong> that ensures native compatibility with your site architecture, enhanced visual presentation, and significantly better technical SEO/AEO performance, <strong>performance analytics dashboard</strong> to track real ROI, and <strong>custom landing page development</strong>. Most importantly, our team handles the complete technical implementation—optimizing code structure, image presentation, schema markup, and cross-platform AI visibility—delivering measurably superior results in both traditional search rankings and AI-powered discovery.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Why do you handle direct posting instead of just sending articles?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>Direct posting isn't just about saving time—it's about technical optimization that most clients can't achieve manually. When our team posts directly to your website, we: <strong>optimize the HTML code structure</strong> for maximum search engine and AI compatibility, <strong>implement advanced schema markup and meta tags</strong> that go far beyond basic JSON-LD, <strong>ensure proper image optimization, alt text, and visual presentation</strong> that enhances both user experience and crawlability, <strong>create native integration</strong> with your existing site architecture rather than generic copy-paste content, and <strong>apply platform-specific AEO techniques</strong> that dramatically improve discovery across ChatGPT, Perplexity, Claude, and other AI systems. This deep technical implementation is why Professional and Enterprise clients see measurably superior results—it's not just content, it's comprehensive technical SEO/AEO engineering integrated directly into your digital presence.</p>
                    </div>
                </div>
...
<!--Tân thêm footer  -->
    <!-- Footer -->
    <footer style="background: linear-gradient(135deg, #1F2937 0%, #111827 100%); color: #FFFFFF; padding: 3rem 0 2rem; text-align: center;">
        <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <!-- Company Name & Tagline -->
            <div style="margin-bottom: 2rem;">
                <h3 style="font-size: 1.8rem; font-weight: 700; color: #FFFFFF; margin-bottom: 0.5rem; letter-spacing: 1px;">AVIXERA</h3>
                <p style="font-size: 1rem; color: rgba(255, 255, 255, 0.6); font-weight: 400;">Medical Content by Licensed M.D.s</p>
            </div>

            <!-- Navigation Links -->
            <div style="margin-bottom: 2rem; padding-bottom: 2rem; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
                <a href="#about" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; margin: 0 1.5rem; font-size: 1rem; transition: all 0.2s ease; display: inline-block;">About</a>
                <a href="#services" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; margin: 0 1.5rem; font-size: 1rem; transition: all 0.2s ease; display: inline-block;">Services</a>
                <a href="#faq" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; margin: 0 1.5rem; font-size: 1rem; transition: all 0.2s ease; display: inline-block;">FAQ</a>
                <a href="#pricing" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; margin: 0 1.5rem; font-size: 1rem; transition: all 0.2s ease; display: inline-block;">Pricing</a>
            </div>

            <!-- Contact -->
            <div style="margin-bottom: 2rem; display: flex; justify-content: center; align-items: center; gap: 2rem; flex-wrap: wrap;">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; color: rgba(255, 255, 255, 0.7); font-size: 0.95rem;">
                    <i class="fas fa-envelope" style="color: #3B82F6; font-size: 1rem;"></i>
                    <span>strategy@topwriter.co</span>
                </div>
            </div>

            <!-- Address -->
            <div style="color: rgba(255, 255, 255, 0.6); font-size: 0.9rem; margin-bottom: 2rem; line-height: 1.6;">
                1207 Delaware Ave, Suite 1176, Wilmington, DE 19806, USA
            </div>

            <!-- Copyright -->
            <div style="color: rgba(255, 255, 255, 0.5); font-size: 0.9rem;">
                <p>© 2025 Avixera LLC. All rights reserved.</p>
            </div>
        </div>
    </footer>
